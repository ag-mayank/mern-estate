...
import { getStorage, getDownloadURL,ref,uploadBytesResumable, connectStorageEmulator } from 'firebase/storage'; 
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-6 flex-wrap'>
                    <div className='flex gap-2'>
                        <input type='checkbox' id='sell' className='w-5'onChange={handleChange} value={formData.type === 'sell '}/>
                        <span>Sell</span>
                    </div>

                    <div className='flex gap-2'>
                        <input type='checkbox' id='rent' className='w-5' onChange={handleChange} value={formData.type === 'rent'}/>
                        <span>Rent</span>
                    </div>
